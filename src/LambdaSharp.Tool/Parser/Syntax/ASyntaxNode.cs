...
namespace LambdaSharp.Tool.Parser.Syntax {
    ...
    public interface ISyntaxVisitor {
        ...
        void VisitStart(ASyntaxNode parent, FunctionVpcDeclaration node);
        void VisitEnd(ASyntaxNode parent, FunctionVpcDeclaration node);
        ...
        void VisitStart(ASyntaxNode parent, ResourcePropertyTypeDeclaration node);
        void VisitEnd(ASyntaxNode parent, ResourcePropertyTypeDeclaration node);
        void VisitStart(ASyntaxNode parent, ResourceAttributeTypeDeclaration node);
        void VisitEnd(ASyntaxNode parent, ResourceAttributeTypeDeclaration node);
