...
namespace LambdaSharp.Tool.Parser {
    ...
    public abstract class ASyntaxVisitor : ISyntaxVisitor {
        ...
        public virtual void VisitEnd(ASyntaxNode parent, ConditionNameLiteralExpression node) { }
        ...
        public virtual void VisitStart(ASyntaxNode parent, ConditionNameLiteralExpression node) { }
