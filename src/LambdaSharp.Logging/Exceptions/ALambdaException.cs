...
namespace LambdaSharp.Exceptions {
    ...
    /// This allows the generated <see cref="LambdaSharp.Logging.ErrorReports.Models.LambdaErrorReport"/> instances to be grouped together by a
    /// log aggregator.
    /// </summary>
    public abstract class ALambdaException : Exception, ILambdaExceptionFingerprinter {
        ...
        /// <summary>
        /// Initializes a <see cref="ALambdaException"/> instance with the specified exception message and inner exception.
        /// </summary>
