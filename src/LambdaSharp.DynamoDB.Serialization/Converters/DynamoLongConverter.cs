...
namespace LambdaSharp.DynamoDB.Serialization.Converters {
    ...
    /// <summary>
    /// The <see cref="DynamoLongConverter"/> class is used to convert <c>long</c> and <c>long?</c> values to/from a DynamoDB attribute value.
    /// </summary>
    public class DynamoLongConverter : ADynamoAttributeConverter {
        ...
        /// </summary>
        public static readonly DynamoLongConverter Instance = new DynamoLongConverter();
        ...
        public override AttributeValue ToAttributeValue(object value, Type targetType, DynamoSerializerOptions options)
            => new AttributeValue {
                N = ((long)value).ToString(CultureInfo.InvariantCulture)
            };
        ...
        public override object? FromNumber(string value, Type targetType, DynamoSerializerOptions options) => long.Parse(value, CultureInfo.InvariantCulture);
    }
}
