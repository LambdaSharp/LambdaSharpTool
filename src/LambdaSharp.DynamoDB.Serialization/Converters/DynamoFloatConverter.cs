...
namespace LambdaSharp.DynamoDB.Serialization.Converters {
    ...
    /// <summary>
    /// The <see cref="DynamoFloatConverter"/> class is used to convert <c>float</c> and <c>float?</c> value to/from a DynamoDB attribute value.
    /// </summary>
    public class DynamoFloatConverter : ADynamoAttributeConverter {
