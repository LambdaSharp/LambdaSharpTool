...
namespace LambdaSharp.DynamoDB.Serialization.Converters {
    ...
    /// <summary>
    /// The <see cref="DynamoISetIntConverter"/> class is used to convert <c>ISet&lt;int&gt;</c> value to/from a DynamoDB attribute value.
    /// </summary>
    public class DynamoISetIntConverter : ADynamoAttributeConverter {
        ...
        private ISet<int> CreateInstance(Type targetType) {
            ...
            if(!targetType.IsAbstract) {
                ...
                return (ISet<int>)(Activator.CreateInstance(targetType) ?? throw new ApplicationException("Activator.CreateInstance() returned null"));
            }
