...
namespace LambdaSharp.DynamoDB.Serialization.Converters {
    ...
    /// <summary>
    /// The <see cref="DynamoEnumConverter"/> class is used to convert GUID value to/from a DynamoDB attribute value.
    /// </summary>
    public class DynamoGuidConverter : ADynamoAttributeConverter {
        ...
        /// </summary>
        public static readonly DynamoGuidConverter Instance = new DynamoGuidConverter();
