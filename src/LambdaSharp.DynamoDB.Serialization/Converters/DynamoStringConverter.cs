...
namespace LambdaSharp.DynamoDB.Serialization.Converters {
    ...
    /// <summary>
    /// The <see cref="DynamoStringConverter"/> class is used to convert <c>string</c> values to/from a DynamoDB attribute value.
    /// </summary>
    public class DynamoStringConverter : ADynamoAttributeConverter {
        ...
        /// </summary>
        public static readonly DynamoStringConverter Instance = new DynamoStringConverter();
        ...
        public override object? FromString(string value, Type targetType, DynamoSerializerOptions options) => value;
    }
}
