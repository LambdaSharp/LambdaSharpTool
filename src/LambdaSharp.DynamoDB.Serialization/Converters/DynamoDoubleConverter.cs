...
namespace LambdaSharp.DynamoDB.Serialization.Converters {
    ...
    /// <summary>
    /// The <see cref="DynamoDoubleConverter"/> class is used to convert <c>double</c> and <c>double?</c> value to/from a DynamoDB attribute value.
    /// </summary>
    public class DynamoDoubleConverter : ADynamoAttributeConverter {
        ...
        /// </summary>
        public static readonly DynamoDoubleConverter Instance = new DynamoDoubleConverter();
        ...
        public override AttributeValue ToAttributeValue(object value, Type targetType, DynamoSerializerOptions options)
            => new AttributeValue {
                N = ((double)value).ToString(CultureInfo.InvariantCulture)
            };
        ...
        public override object? FromNumber(string value, Type targetType, DynamoSerializerOptions options) => double.Parse(value, CultureInfo.InvariantCulture);
    }
}
