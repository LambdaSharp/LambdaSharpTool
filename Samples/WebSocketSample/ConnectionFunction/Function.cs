    ...
    public class Function : ALambdaApiGatewayFunction {
        ...
        public async Task OpenConnectionAsync(APIGatewayProxyRequest request) {
            try {
                ...
                LogError(e);
                throw Abort(CreateStatusResponse(500, $"Failure while attempting to connect: {e.Message}"));
            }
        }
        ...
        public async Task CloseConnectionAsync(APIGatewayProxyRequest request) {
            try {
                ...
                LogError(e);
                throw Abort(CreateStatusResponse(500, $"Failure while attempting to disconnect: {e.Message}"));
            }
        }
    }
}
