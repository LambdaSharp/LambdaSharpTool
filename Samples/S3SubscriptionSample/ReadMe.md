...
The S3 event can be parsed into a `S3Event` message instance by using the `ALambdaFunction<TRequest,TResponse>` base class and including the `Amazon.Lambda.S3Events` nuget package.
