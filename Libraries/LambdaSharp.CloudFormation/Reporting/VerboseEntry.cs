...
namespace LambdaSharp.CloudFormation.Reporting {
    ...
    public sealed class VerboseEntry : IReportEntry {

        //--- Constructors ---
        public VerboseEntry(string message) => Message = message ?? throw new ArgumentNullException(nameof(message));
        ...
        public override bool Equals(object? obj)
            => (obj is VerboseEntry other) && Equals(other);
