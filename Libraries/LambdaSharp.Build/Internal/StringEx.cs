...
namespace LambdaSharp.Build.Internal {
    ...
    internal static class StringEx {
        ...
        public static bool TryParseAssemblyClassMethodReference(string reference, [NotNullWhen(true)] out string? assemblyName, [NotNullWhen(true)] out string? className, [NotNullWhen(true)] out string? methodName) {
